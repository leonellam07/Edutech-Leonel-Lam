...
public class TransaccionDto {
    ...
    public TransaccionDto(Integer id, CuentaDto cuenta, Date fecha, float monto, TipoTransaccionDto tipoTransaccion, String detalle, Integer idCuentaTrans) {
        this.id = id;
        this.cuenta = cuenta;
        this.fecha = fecha;
        this.monto = monto;
    ...
    public TransaccionDto(CuentaDto cuenta, float monto, TipoTransaccionDto tipoTransaccion, String detalle, Integer idCuentaTrans) {
        this.cuenta = cuenta;
        this.fecha = new Date();
        this.monto = monto;
        this.tipoTransaccion = tipoTransaccion;
