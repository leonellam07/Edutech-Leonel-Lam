    ...
    insert into usuario (id,codigo,email,nombre,password,telefono,ID_CLIENTE) values (2, 'yesteban', 'yesteban09@gmail.com',  'Yoli Esteban',  null, '3423423',2);
    insert into usuario (id,codigo,email,nombre,password,telefono,ID_CLIENTE) values (3, 'jlpazos', 'leokirap014@gmail.com',  'Jorge Leonel Lam Pazos',  null, '534563',3);
    insert into usuario (id,codigo,email,nombre,password,telefono,ID_CLIENTE) values (4, 'mmutzus', 'elmutzus@gmail.com',   'Manuel Mutzus',  null, '3456456',4);
    insert into usuario (id,codigo,email,nombre,password,telefono,ID_CLIENTE) values (5, 'arigalt', 'arigalt@gmail.com',  'Alejandro Rigalt',  null, '57456567',5);
    insert into usuario (id,codigo,email,nombre,password,telefono,ID_CLIENTE) values (6, 'btorres', 'bernyt0rr3s@gmail.com',   'Bern Torres',  null, '4567567', 6);
